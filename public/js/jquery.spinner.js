    ...
    $.fn.spinner = function(options) {
        ...
        return this.each(function() {
            ...
            if( typeof document.body.style.maxHeight != "undefined" ){
              ...
              //IE6以下
              $s = $('<iframe scrolling="no" frameborder="0" style="filter: alpha(style=0, opacity=0);position: absolute; left: ' + l +'; top: ' + t + '; width: ' + opts.width + 'px; height: ' + opts.height + 'px; z-index: ' + opts.zIndex + ';"></iframe><img src="' + opts.img + '" style="position: absolute; left: ' + l +'; top: ' + t + '; width: ' + opts.width + 'px; height: ' + opts.height + 'px; z-index: ' + opts.zIndex + ';" />').appendTo('body');
            }
