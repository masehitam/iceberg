...
<div class="form-group col-sm-12 col-lg-12 @if($errors->has('options')) has-error @endif">
    ...
    {!! Form::textarea('options', null, ['class' => 'wysiwyg form-control']) !!}
...
<div class="form-group col-sm-12 col-lg-12 @if($errors->has('default_value')) has-error @endif">
    ...
    {!! Form::textarea('default_value', null, ['class' => 'wysiwyg form-control']) !!}
...
<div class="form-group col-sm-12">
    @if (app('request')->input('parent_id') != '') {!! Form::hidden('parent_id', app('request')->input('parent_id')) !!} @endif
